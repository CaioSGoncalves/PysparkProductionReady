...
class TestMoviesJob:
    def test_transform_data(self, spark_session):
        ...
        real_data = movie._transform_data(test_data).toPandas()
    ...
    #         ["movieId", "title", "genres"],
    #     )
    #     mocker.patch.object(movie, "_extract_data")
    #     movie._extract_data.return_value = test_data
    #     movie.run_job(spark_session, test_config)
